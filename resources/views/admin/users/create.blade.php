...
@section('title', 'Tambah Akun Pengguna - Admin P3M')
        ...
        <header class="bg-white border-b border-slate-200 py-4 sticky top-0 z-30 shadow-xs">
            <div class="w-full px-4 sm:px-6 lg:px-8 flex items-center justify-between">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h1 class="font-extrabold text-xl text-slate-900 leading-tight">Buat Akun Pengguna Baru</h1>
                        <p class="text-xs font-semibold text-slate-500">Daftarkan akun dosen, pimpinan, reviewer, atau staf baru di PRISMA UHN</p>
                    </div>
                </div>
            </div>
        </header>
                ...
                <form method="POST" action="{{ route('admin.users.store') }}" class="p-6 sm:p-8 space-y-6">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div class="sm:col-span-2">
                                ...
                                <input type="text" name="name" value="{{ old('name') }}" required
                                       placeholder="Contoh: Sharfina Febbi Handayani, S.Kom., M.Kom."
                            ...
                            <div>
                                ...
                                <input type="text" name="nidn_nim" value="{{ old('nidn_nim') }}"
                                       placeholder="Contoh: 0617029201 (10 digit)"
                            ...
                            <div>
                                ...
                                <input type="email" name="email" value="{{ old('email') }}" required
                                       placeholder="nama.dosen@harkatnegeri.ac.id"
                            ...
                            <div>
                                ...
                                <input type="password" name="password" required minlength="6"
                                       placeholder="Disarankan isi dengan NIDN dosen"
                                       class="w-full px-4 py-2.5 rounded-xl border border-slate-200 text-xs font-semibold text-slate-800 focus:outline-hidden focus:ring-2 focus:ring-[#681727]">
                                <p class="text-[10px] text-slate-400 mt-1">Kata sandi akan otomatis di-hash aman.</p>
                            </div>
                    ...
                    <div class="space-y-4 pt-4">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="sinta_id" value="{{ old('sinta_id') }}"
                            ...
                            @foreach($roles as $r)
                                <label class="p-3 rounded-2xl border border-slate-200 hover:border-[#681727] cursor-pointer transition flex items-start gap-2.5 bg-slate-50/60">
                                    <input type="checkbox" name="roles[]" value="{{ $r->id }}"
                                           {{ in_array($r->id, old('roles', [1])) ? 'checked' : '' }}
                    ...
                    <div class="pt-6 border-t border-slate-100 flex items-center justify-end gap-3">
                        ...
                        <button type="submit"
                            ...
                            <span style="color: #ffffff !important;">Simpan &amp; Buat Akun</span>
                        </button>
                    </div>
                </form>
            </div>
